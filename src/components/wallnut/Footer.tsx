  ...
  return (
    <footer ref={footerRef} style={{ background: '#202A30', fontFamily: 'Inter, sans-serif', position: 'relative', overflow: 'hidden' }}>
      ...
      {/* ══════════════════════════════════════════
          BIG CTA HEADLINE
      ══════════════════════════════════════════ */}
      <div style={{ padding: 'clamp(3rem,6vw,6rem) clamp(1.25rem,5vw,5rem) 0', position: 'relative' }}>
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          ...
          {/* ══════════════════════════════════════════
              MAIN FOOTER GRID
          ══════════════════════════════════════════ */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 220px), 1fr))', gap: 'clamp(2rem,4vw,4rem)', marginBottom: 'clamp(3rem,5vw,5rem)' }}>
              ...
              <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.1rem' }}>
                {navLinks.map((link, i) => (
                  <Link
                    ...
                    onMouseEnter={e => { e.currentTarget.style.color = '#FDC41F'; }}
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <a href="tel:9040099001"
                  style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', color: 'rgba(255,255,255,0.55)', fontSize: '0.95rem', fontWeight: 500, textDecoration: 'none' }}
                ...
                <a href="mailto:saiaakankshya.associates@gmail.com"
                  style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', color: 'rgba(255,255,255,0.55)', fontSize: '0.88rem', fontWeight: 500, textDecoration: 'none', lineHeight: 1.5 }}
                  onMouseEnter={e => (e.currentTarget.style.color = '#fff')}
                  onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.55)')}>
            ...
            <div>
              ...
              <a href="https://maps.google.com/?q=Rasulgarh,Bhubaneswar,Odisha" target="_blank" rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem', color: 'rgba(255,255,255,0.55)', fontSize: '0.95rem', fontWeight: 500, textDecoration: 'none', lineHeight: 1.7 }}
                onMouseEnter={e => (e.currentTarget.style.color = '#fff')}
                onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.55)')}>
                ...
                <span>434, Lane 5, Niladri Vihar,<br />Chandrasekharpur, Bhubaneswar,<br />Odisha – 751021</span>
              </a>
            </div>
